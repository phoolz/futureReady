...
namespace Apiary.Services.LogbookEntries
{
    public interface ILogbookEntryService
    {
        ...
        Task<List<LogbookEntry>> GetByPlacementStudentIdAsync(Guid placementStudentId, Guid? tenantId = null);
        ...
        Task<decimal> GetTotalHoursAsync(Guid placementStudentId, Guid? tenantId = null);
    }
}
